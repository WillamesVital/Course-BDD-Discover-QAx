...
Então('eu devo ver uma lista de cafés disponivéis') do
...
Então('devo ver um popup informando que o produto está indisponivél') do
    @popup.have_text('Produto indisponivél')
end