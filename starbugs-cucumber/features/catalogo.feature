...
Funcionalidade: Catálogo de Cafés
    ...
    Para que eu possa escolher e saber mais sobre os produtos disponivéis

Cenário: Acessar o catálogo de cafés na página principal

    Quando acesso a página principal da Starbugs
    Então eu devo ver uma lista de cafés disponivéis
...
Cenário: Café indisponivél

     Dado que estou na página principal da Starbugs
        E que desejo comprar o seguinte produto:
        | name     | Expresso Cremoso |
    Quando inicio a compra desse item
    Então devo ver um popup informando que o produto está indisponivél